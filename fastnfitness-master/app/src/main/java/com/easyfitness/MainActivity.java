...
public class MainActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    private final PopupMenu.OnMenuItemClickListener onMenuItemClick = item -> {
        ...
        // 🔥 ADD THIS BLOCK
            ...
            Toast.makeText(getActivity(), "Upgrade to Pro Clicked", Toast.LENGTH_SHORT).show();
            startPayment();   // 💳 OPEN PAYMENT
            return true;
        }
    ...
    public void startPayment() {
        ...
        checkout.setKeyID("rzp_test_SZIjqZnvrIdCsz"); // 🔑 your key

        try {
            JSONObject options = new JSONObject();
            options.put("name", "Fast N Fitness");
            options.put("description", "Upgrade to Pro");
            options.put("currency", "INR");
            options.put("amount", "2");
